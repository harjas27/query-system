...
public class HubSpotConnector extends AbstractConnector {
    ...
    public HubSpotConnector(IntegrationServiceClient integrationServiceClient, ModelStoreClient modelStoreClient, IntegrationServiceClient.Application application) {
    ...
    private String getURLString(AuthInfo authInfo, UniversalQuery query) {
        ...
        return application.getEndpoint() + "/objects" + objectName + "/search";
    }
    ...
    private String updateFieldsInResponse(AuthInfo authInfo, String response, UniversalQuery query) {
        ...
        for (JsonElement object : responseJson) {
            ...
            for (Map.Entry<String, JsonElement> stringJsonElementEntry : asJsonObject.entrySet()) {
                updatedObject.add(fieldNames.getOrDefault(stringJsonElementEntry.getKey(), stringJsonElementEntry.getKey()), stringJsonElementEntry.getValue());
            }
